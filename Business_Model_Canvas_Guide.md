...
graph TB
    ...
    style Chan fill:#fff9c4
    style RS fill:#f3e5f5
    style CustSeg fill:#ffccbc
```
...
graph LR
    ...
    E -->|Build| F["Customer Relationships"]
    F -->|Generate| G["Revenue Streams"]
    G -->|Fund| H["Cost Structure"]
    H -->|Required for| B
...
```mermaid
graph TB
    subgraph Left["SUPPLY SIDE"]
        KP1["20+ Local Organic Farms"]
        KP2["Packaging Supplier"]
    ...
    subgraph Middle["VALUE CREATION"]
        KA1["Daily Meal<br/>Preparation"]
    ...
    subgraph Right["CUSTOMER SIDE"]
        ...
        CS3["Corporate<br/>Wellness"]
        RS["Subscriptions<br/>Pay-per-meal<br/>Corporate Plans<br/>Premium Tiers"]
    end
    ...
    style VP fill:#90EE90,stroke:#2d5016,stroke-width:3px,color:#000
    style CS fill:#FFB6C1,stroke:#8b0000,stroke-width:2px
    style KA1 fill:#fff3e0
    style KA2 fill:#fff3e0
    style KA3 fill:#fff3e0
    style KA4 fill:#fff3e0
    style CR1 fill:#fff9c4
    style CR2 fill:#fff9c4
    style CR3 fill:#fff9c4
    style CHAN1 fill:#e1f5ff
    style CHAN2 fill:#e1f5ff
    style CHAN3 fill:#e1f5ff
    style RS fill:#f3e5f5,stroke:#4a148c,stroke-width:2px,color:#fff
```
